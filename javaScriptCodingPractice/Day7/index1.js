let year=2005;
if(year>2004){
    document.write("Your are eligible to vote")
}

let age=prompt("Enter your exact age: ");
if(age>=18){
    document.write("<br>Your are eligible to vote");
}

if(0){
    document.write("<br>This will not be printed");
}
if(1){
    document.write("<br>This will be printed")
